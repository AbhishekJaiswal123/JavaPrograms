...
public class DuplicateArray {
    ...
    public static int repeatedNumber(final List<Integer> a) {
        ...
        for(int i = 0 ; i < a.size() ; i++){
            int value = map.get(a.get(i)) != null ? map.get(a.get(i))+1 : 1;
